        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="md:col-span-1">
                    <img src="/assets/images/healthsyncx-logo-light.png" alt="HealthSyncX" class="h-24 mb-3 dark:hidden">
                    <img src="/assets/images/healthsyncx-logo-dark.png" alt="HealthSyncX" class="h-24 mb-3 hidden dark:block">
                </div>
            ...
            <div class="mt-8 pt-8 border-t border-border text-center">
                <p class="text-sm text-muted-foreground">
                    &copy; <?php echo date('Y'); ?> HealthSyncX. All rights reserved. | Serving Asia Pacific Region
                </p>
            </div>
        </div>
    </footer>
